...
export const TRAINER_LINES: string[] = [
  ...
  'Tay cần 6 điểm đấy — Push-up và Lat Pull Down đều dùng tay.',
  'Nhớ tập cả 6 nhóm cơ, thiếu một nhóm là thử thách cuối "toang".',
...
export const PROFESSOR_LINES: string[] = [
  ...
  'Mỗi khối kiến thức cần ít nhất 2 lần học. Đừng bỏ trống khối nào.',
